  ...
  return (
    <div data-scroll data-scroll-speed="-.20">
      <motion.div
        ...
        className="w-full h-screen p-20 bg-[#fff]  text-black flex justify-between sticky"
      >
        <div className="w-1/2 h-full flex justify-between flex-col ">
          <div className="heading ">
            <h1 className="text-[6vw] -mb-5 font-semibold leading-none tracking-tighter">
              EYE-{" "}
            </h1>
            <h1 className="text-[6vw] font-semibold tracking-tighter ">
              OPENING{" "}
            </h1>
          </div>
          <svg
        ...
        <div className="w-1/2">
          ...
          <div className="dets flex flex-col gap-10 justify-around text-xl font-['Neue_Montreal']">
